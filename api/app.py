...
def company_month(dates):
   ...
   for employee in summary:
       ...
       employee_data['morningTimeOut'] = (employee.morningTimeOut).strftime("%Y-%m-%d %H:%M")
       employee_data['afterTimeIn'] = (employee.afterTimeIn).strftime("%Y-%m-%d %H:%M")
       employee_data['afterTimeOut'] = (employee.afterTimeOut).strftime("%Y-%m-%d %H:%M")
