...
def company_month(dates):
   ...
   for employee in summary:
       ...
       employee_data['morningTimeIn'] = dt.datetime.strptime(employee.morningTimeIn, "%m-%d-%Y %H:%M")
       employee_data['morningTimeOut'] = dt.datetime.strptime(employee.morningTimeOut, "%m-%d-%Y %H:%M")
       employee_data['afterTimeIn'] = dt.datetime.strptime(employee.afterTimeIn, "%m-%d-%Y %H:%M")
       employee_data['afterTimeOut'] = dt.datetime.strptime(employee.afterTimeOut, "%m-%d-%Y %H:%M")
